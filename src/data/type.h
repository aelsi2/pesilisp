...
// Special ref_count value that disables reference counting.
...
struct obj_type_s {
    ...
    size_t size;
    result_t (*eval)(object_t *object, env_t *env, int recursion_limit,
                     bool *dirty);
...
result_t obj_eval_self(object_t *object, env_t *env, int recursion_limit,
                       bool *dirty);
